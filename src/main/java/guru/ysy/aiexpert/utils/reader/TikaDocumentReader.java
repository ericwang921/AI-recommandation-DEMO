 ...
 */
package guru.ysy.aiexpert.utils.reader;
...
/**
 * This class comes from spring-ai-tika-document-reader:1.0.0. Currently, the jar package
 * cannot be imported properly, so the class is directly added here. Thanks to the original
 * author for the encapsulation of Apache tika.
 *
